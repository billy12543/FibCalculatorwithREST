...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\tfib.proto\"\x1b\n\nFibRequest\x12\r\n\x05order\x18\x01 \x01(\x03\"\x1c\n\x0b\x46ibResponse\x12\r\n\x05value\x18\x01 \x01(\x03\"$\n\x11\x46ibHistoryContext\x12\x0f\n\x07history\x18\x01 \x01(\t25\n\rFibCalculator\x12$\n\x07\x43ompute\x12\x0b.FibRequest\x1a\x0c.FibResponse28\n\nFibHistory\x12*\n\x07\x43ompute\x12\x0b.FibRequest\x1a\x12.FibHistoryContextb\x06proto3'
)
...
_FIBHISTORYCONTEXT = _descriptor.Descriptor(
  name='FibHistoryContext',
  full_name='FibHistoryContext',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='history', full_name='FibHistoryContext.history', index=0,
...
DESCRIPTOR.message_types_by_name['FibHistoryContext'] = _FIBHISTORYCONTEXT
...
FibHistoryContext = _reflection.GeneratedProtocolMessageType('FibHistoryContext', (_message.Message,), {
  'DESCRIPTOR' : _FIBHISTORYCONTEXT,
  '__module__' : 'fib_pb2'
  # @@protoc_insertion_point(class_scope:FibHistoryContext)
  })
_sym_db.RegisterMessage(FibHistoryContext)
...
_FIBHISTORY = _descriptor.ServiceDescriptor(
  name='FibHistory',
  full_name='FibHistory',
  file=DESCRIPTOR,
  index=1,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Compute',
    full_name='FibHistory.Compute',
    index=0,
    containing_service=None,
    input_type=_FIBREQUEST,
    output_type=_FIBHISTORYCONTEXT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
_sym_db.RegisterServiceDescriptor(_FIBHISTORY)

DESCRIPTOR.services_by_name['FibHistory'] = _FIBHISTORY
