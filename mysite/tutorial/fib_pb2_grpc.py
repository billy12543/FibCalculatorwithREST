...
from . import fib_pb2 as fib__pb2
...
class FibHistoryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Compute = channel.unary_unary(
                '/FibHistory/Compute',
                request_serializer=fib__pb2.FibRequest.SerializeToString,
                response_deserializer=fib__pb2.FibHistoryContext.FromString,
                )


class FibHistoryServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FibHistoryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Compute': grpc.unary_unary_rpc_method_handler(
                    servicer.Compute,
                    request_deserializer=fib__pb2.FibRequest.FromString,
                    response_serializer=fib__pb2.FibHistoryContext.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'FibHistory', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class FibHistory(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Compute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/FibHistory/Compute',
            fib__pb2.FibRequest.SerializeToString,
            fib__pb2.FibHistoryContext.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
